...
| `skill` | string | Non-empty. Must name one of the repo's skills: `ent-stage-router`, `ent-pmf-evaluator`, `ent-unit-econ-check`, `ent-office-hours`, `ent-concept-test`, `ent-mvp-scoper`, `ent-red-team`, `ent-intake`, `ent-pivot-coach`, `ent-thesis`, `ent-career-coach`, `ent-diligence`, `ent-first-customers`. |
...
ALLOWED_SKILLS = {
    ...
    "ent-intake", "ent-pivot-coach", "ent-thesis", "ent-career-coach", "ent-diligence", "ent-first-customers",
}
